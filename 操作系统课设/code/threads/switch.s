...
SWITCH:
	...
	stq s4,S4(a0)
	stq s5,S5(a0)
	stq fp,FP(a0)		# save frame pointer
	stq gp,GP(a0)		# save global pointer
	...
	ldq s4,S4(a1)
	ldq s5,S5(a1)
	ldq fp,FP(a1)		# load frame pointer
	ldq gp,GP(a1)		# load global pointer
	ldq ra,PC(a1)		# load return address

	jmp (ra)			# execute context-switch
	ldgp gp,0(ra)
	ret zero,(ra),1
	.end SWITCH
